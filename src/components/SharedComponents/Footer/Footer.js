                    ...
                    <div className="col-11">
                        <div className="row pe-5">
                            <div className="col-xl-8 col-md-4 col-sm-4 col-12 my-auto mx-auto a">
                                <h3 className="text-muted mb-md-0 mb-5 bold-text h3">Care For.</h3>
                            </div>
                        ...
                        <div className="row pe-5">
                            <div className="col-xl-8 col-md-4 col-sm-4 col-auto my-md-0 mt-5 order-sm-1 order-3 align-self-end">
                                ...
                                <small className="rights small"><span>&#174;</span> Team Care For. All Rights Reserved.</small>
                            </div>
                            <div className="col-xl-2 col-md-4 col-sm-4 col-auto order-1 align-self-end ">
                                <h6 className="mt-55 mt-2 text-muted bold-text"><b>Team Care For</b></h6><small> <span><i
                                    className="fa fa-envelope small" aria-hidden="true"></i></span> team.carefor@gmail.com</small>
                            </div>
                            <div className="col-xl-2 col-md-4 col-sm-4 col-auto order-2 align-self-end mt-3 ">
                                <h6 className="text-muted bold-text"><b>Ashraful Alam</b></h6><small><span><i
                                    className="fa fa-envelope small" aria-hidden="true"></i></span> ashraful.3079@gmail.com</small>
                            </div>
                        </div>
                    </div>
                </div>
